...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var foundation_sites__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! foundation-sites */ "./node_modules/foundation-sites/dist/js/npm.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  ==================================================
  */
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#reveal-button').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).fadeOut(300);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#mce-EMAIL').focus();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#mc-embedded-subscribe').addClass('show');
  });
  var input_selector = 'input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], input[type=date], input[type=time], textarea';

  var inputUI = function inputUI() {
    var inputs = jquery__WEBPACK_IMPORTED_MODULE_0___default()(input_selector);
    inputs.each(function (index, el) {
      var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);

      if (el.value.length > 0 || jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).is(':focus') || el.autofocus //||
  ...
  document.addEventListener('focus', function (e) {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).is(input_selector)) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).addClass('input-full');
    }
  }, true); //document.addEventListener('blur', function(e) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#mc-embedded-subscribe-form').submit(function (e) {
    e.preventDefault();
    submitSubscribeForm(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#mc-embedded-subscribe-form'), jquery__WEBPACK_IMPORTED_MODULE_0___default()('#form-result'));
  });
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      success: function success(data) {
        if (data.result != "success") {
          ...
          $resultElement.html("");
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#mc_embed_signup_scroll').html('<div class="form-thankyou">THANK YOU</div>');
        }
      }
    });
  }
  ...
  */
  ...
  var injector = new libs.svgInjector(injectorOptions); // Trigger the injection
...
module.exports = __webpack_require__(/*! /Users/isaac/Development/estuary/src/assets/js/app.js */"./src/assets/js/app.js");
